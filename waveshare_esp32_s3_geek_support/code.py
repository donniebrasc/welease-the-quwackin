...
#waveshare_esp32_s3_geek support
...
if(board.board_id == 'raspberry_pi_pico_w'):
  import wifi
  from webapp import *
if(board.board_id == 'waveshare_esp32_s3_geek'):
  import wifi
  from webapp import *
...
async def main_loop():
    ...
    if(board.board_id == 'raspberry_pi_pico_w'):
        ...
        startWiFi()
    if(board.board_id == 'waveshare_esp32_s3_geek'):
        waveshare_esp32_s3_geek_led_task = asyncio.create_task(blink_waveshare_esp32_s3_geek_led(led))
        print("Starting Wifi")
        startWiFi()
        ...
        print("Starting Web Service")
        webservice_task = asyncio.create_task(startWebService())
        await asyncio.gather( waveshare_esp32_s3_geek_led_task, button_task, webservice_task)
